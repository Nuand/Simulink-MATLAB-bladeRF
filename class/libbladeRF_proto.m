...
%This function was generated by loadlibrary.m parser version  on Wed Sep  9 19:44:04 2015
%perl options:'libbladeRF.i -outfile=libbladeRF_proto.m -thunkfile=libbladeRF_thunk_glnxa64.c -header=libbladeRF.h'
...
enuminfo.bladerf_tuning_mode=struct('BLADERF_TUNING_MODE_INVALID',-1,'BLADERF_TUNING_MODE_HOST',0,'BLADERF_TUNING_MODE_FPGA',1);
enuminfo.bladerf_format=struct('BLADERF_FORMAT_SC16_Q11',0,'BLADERF_FORMAT_SC16_Q11_META',1);
enuminfo.bladerf_lpf_mode=struct('BLADERF_LPF_NORMAL',0,'BLADERF_LPF_BYPASSED',1,'BLADERF_LPF_DISABLED',2);
enuminfo.bladerf_xb200_path=struct('BLADERF_XB200_BYPASS',0,'BLADERF_XB200_MIX',1);
enuminfo.bladerf_correction=struct('BLADERF_CORR_LMS_DCOFF_I',0,'BLADERF_CORR_LMS_DCOFF_Q',1,'BLADERF_CORR_FPGA_PHASE',2,'BLADERF_CORR_FPGA_GAIN',3);
enuminfo.bladerf_cal_module=struct('BLADERF_DC_CAL_LPF_TUNING',0,'BLADERF_DC_CAL_TX_LPF',1,'BLADERF_DC_CAL_RX_LPF',2,'BLADERF_DC_CAL_RXVGA2',3);
enuminfo.bladerf_log_level=struct('BLADERF_LOG_LEVEL_VERBOSE',0,'BLADERF_LOG_LEVEL_DEBUG',1,'BLADERF_LOG_LEVEL_INFO',2,'BLADERF_LOG_LEVEL_WARNING',3,'BLADERF_LOG_LEVEL_ERROR',4,'BLADERF_LOG_LEVEL_CRITICAL',5,'BLADERF_LOG_LEVEL_SILENT',6);
enuminfo.bladerf_loopback=struct('BLADERF_LB_FIRMWARE',1,'BLADERF_LB_BB_TXLPF_RXVGA2',2,'BLADERF_LB_BB_TXVGA1_RXVGA2',3,'BLADERF_LB_BB_TXLPF_RXLPF',4,'BLADERF_LB_BB_TXVGA1_RXLPF',5,'BLADERF_LB_RF_LNA1',6,'BLADERF_LB_RF_LNA2',7,'BLADERF_LB_RF_LNA3',8,'BLADERF_LB_NONE',9);
enuminfo.bladerf_lna_gain=struct('BLADERF_LNA_GAIN_UNKNOWN',0,'BLADERF_LNA_GAIN_BYPASS',1,'BLADERF_LNA_GAIN_MID',2,'BLADERF_LNA_GAIN_MAX',3);
enuminfo.bladerf_sampling=struct('BLADERF_SAMPLING_UNKNOWN',0,'BLADERF_SAMPLING_INTERNAL',1,'BLADERF_SAMPLING_EXTERNAL',2);
enuminfo.bladerf_module=struct('BLADERF_MODULE_RX',0,'BLADERF_MODULE_TX',1);
enuminfo.bladerf_dev_speed=struct('BLADERF_DEVICE_SPEED_UNKNOWN',0,'BLADERF_DEVICE_SPEED_HIGH',1,'BLADERF_DEVICE_SPEED_SUPER',2);
enuminfo.bladerf_xb=struct('BLADERF_XB_NONE',0,'BLADERF_XB_100',1,'BLADERF_XB_200',2);
enuminfo.bladerf_backend=struct('BLADERF_BACKEND_ANY',0,'BLADERF_BACKEND_LINUX',1,'BLADERF_BACKEND_LIBUSB',2,'BLADERF_BACKEND_CYPRESS',3,'BLADERF_BACKEND_DUMMY',100);
enuminfo.bladerf_fpga_size=struct('BLADERF_FPGA_UNKNOWN',0,'BLADERF_FPGA_40KLE',40,'BLADERF_FPGA_115KLE',115);
enuminfo.bladerf_xb200_filter=struct('BLADERF_XB200_50M',0,'BLADERF_XB200_144M',1,'BLADERF_XB200_222M',2,'BLADERF_XB200_CUSTOM',3,'BLADERF_XB200_AUTO_1DB',4,'BLADERF_XB200_AUTO_3DB',5);
enuminfo.bladerf_image_type=struct('BLADERF_IMAGE_TYPE_INVALID',-1,'BLADERF_IMAGE_TYPE_RAW',0,'BLADERF_IMAGE_TYPE_FIRMWARE',1,'BLADERF_IMAGE_TYPE_FPGA_40KLE',2,'BLADERF_IMAGE_TYPE_FPGA_115KLE',3,'BLADERF_IMAGE_TYPE_CALIBRATION',4,'BLADERF_IMAGE_TYPE_RX_DC_CAL',5,'BLADERF_IMAGE_TYPE_TX_DC_CAL',6,'BLADERF_IMAGE_TYPE_RX_IQ_CAL',7,'BLADERF_IMAGE_TYPE_TX_IQ_CAL',8);
methodinfo=fcns;